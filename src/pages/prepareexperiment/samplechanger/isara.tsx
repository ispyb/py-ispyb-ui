...
export class ISARA extends AbstractSampleChanger {
  ...
  getX(position: number): number {
    ...
    if (drawingPosition.nbColumn == 5) {
      return [-this.sampleChangerRadius * 0.6, -this.sampleChangerRadius * 0.3, 0, this.sampleChangerRadius * 0.3, this.sampleChangerRadius * 0.6][drawingPosition.column];
    }
    ...
    if (drawingPosition.nbColumn == 2) {
      return [-this.sampleChangerRadius * 0.15, this.sampleChangerRadius * 0.15][drawingPosition.column];
    }
    return 0;
  }
  ...
  getDrawingPosition(position: number): { line: number; column: number; nbColumn: 5 | 6 | 2 } {
    if (position < 5) {
