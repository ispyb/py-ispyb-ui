...
export default function DataCollectionPanel({ sessionId, proposalName, dataCollection }: Props) {
  return (
    <Card>
      <Container>
        <Row>
          ...
          <Col>
            <SimpleParameterTable
              parameters={[
                ...
                {
                  key: 'En. (Wave.)',
                  value: `${convertToFixed(wavelengthToEnergy(dataCollection.DataCollection_wavelength), 3)}  KeV (${convertToFixed(
                    dataCollection.DataCollection_wavelength,
                    4
                  )} )`,
                },
